            ...
            endActionPane: ActionPane(
              ...
              children: [
                GestureDetector(
                  onTap: () {
                    setState(() {
                      notes.remove(noteTitle); // Remove the note from the map
                      notesComp.remove(Note);  // Remove its completion status
                    });
                  },
                  child: Container(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: ListTile(
                  ...
                  trailing: IconButton(
                    onPressed: () {
                      // Populate the controllers with the current note data
                                ...
                                child: InkWell(
                                  onTap: () {
                                    ...
                                    if (updatedTitle.isNotEmpty) {
                                      setState(() {
                                        notes.remove(noteTitle); // Remove the old note
                                        notes[updatedTitle] = updatedNote; // Add updated note
                                        notesComp[updatedNote] = isCompleted; // Preserve completion status
                                      });
                                    }
